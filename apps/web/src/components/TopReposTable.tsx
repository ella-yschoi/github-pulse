  ...
  return (
    <div className='bg-white p-4 sm:p-6 rounded-lg shadow-sm border'>
      ...
      <div className='sm:hidden space-y-3'>
        {repos.map((repo, index) => (
          <div key={repo.full_name} className='bg-gray-50 rounded-lg p-4'>
            {/* Top row: rank and views */}
            ...
            <a
              ...
              target='_blank'
              rel='noreferrer'
              className='text-sm font-medium text-gray-900 hover:text-emerald-600 block truncate'
              title={repo.full_name}
            >
              {repo.full_name}
            </a>

            {/* Bottom row: stars and sparkline */}
